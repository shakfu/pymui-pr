...
cdef class Context:
    ...
    #     cdef mu_Style* _style_ptr = <mu_Style*>(self.ptr.style[0])
    #     cdef Style _style = Style.from_ptr(_style_ptr)
    #     return _style

    # @property
    # def style(self) -> Style:
    #     cdef Style _style = Style.from_ptr(<mu_Style*>self.ptr.style)
    #     return _style

    # @property
    # def title_height(self) -> int:
    #     return self.ptr[0].style.title_height
